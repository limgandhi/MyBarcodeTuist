...
//  BarcodeTest
//
//  Created by Hyunyou Lim on 2022/04/04.
//
...
class ReaderView: UIView{
    ...
    let metadataObjectTypes: [AVMetadataObject.ObjectType] = [.upce, .code39, .code39Mod43, .code93, .code128, .ean8, .ean13, .aztec, .pdf417, .itf14, .dataMatrix, .interleaved2of5]
    ...
    private func setCenterGuideLineView() {
        ...
        //color literal
        centerGuideLineView.backgroundColor = #colorLiteral(red: 0, green: 0.4456313776, blue: 0, alpha: 1)
